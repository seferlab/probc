...
class TestSEDFMest():
    ...
    @staticmethod
    def testPreNonParamData(marklist,domlist,sortmarkers,varcount,nodecount,params,compcount,stlogcoefs,endlogcoefs):
    ...
    @staticmethod
    def testDomainParamEstimate(marklist,domlist,paramdict,sortmarkers,sidecoefs,nodecounts,params):
        """tests domain param estimate
        Args:
        Returns:
           bool: true or false
        """
        ...
        if params['model'] in ["binary","linear"]:
           ...
           print "not done"
           exit(1)  
        #elif params['model'] == "linear" and params['infermodel'] == "double":
